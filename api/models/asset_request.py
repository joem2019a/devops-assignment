...
class AssetRequest(*Base):
  ...
  asset_id = Column('asset_request_id', Integer, primary_key=True)
  asset_type_id = Column('asset_type_id', ForeignKey('AssetType.asset_type_id'), nullable=False)
  requesting_user_id = Column('requesting_user_id', ForeignKey('User.user_id'), nullable=False)
  ...
  def __init__(self, asset_type, user, notes, status):
